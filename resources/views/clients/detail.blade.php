...
@section('contenu')
    <section id="home-section" class="hero">
        <div class="home-slider owl-carousel">
            ...
            <div class="slider-item" style="background-image: url({{ asset('storage/Slider_image/Miyakojima-Okinawa-Japon-03_1682237031.jpg') }});">
                    <div class="overlay"></div>
                <div class="container">
                    <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                    <div class="col-md-12 ftco-animate text-center">
                        <h1 class="mb-2">Merci de nous faire confiance</h1>
                        ...
                        <div class="col-md-6 order-md-last align-items-stretch d-flex">
                            <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(frontend/images/category.jpg);">
                                <div class="text text-center">
                                    <h2>Description</h2>
                                    <pre>{{ $trano->Description}}</pre>
                                    <p>Lieu {{ $trano->Adresse }}</p>
                                    <p>Prix : {{ $trano->Prix }}.00 Ar</p>
                                    <p><a href="/ajouter_au_panier/{{ $trano->id }}" class="btn btn-primary">Ajouter au panier</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
    ...
    <div class="container">
        ...
        <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading">{{ $trano->Nom }}</span>
        <h2 class="mb-4">Voici l'illustration de la maison {{ $trano->Nom}} en image</h2>
        <p></p>
        </div>
    </div>   		
    </div>
        ...
        <div class="row">
            ...
            @foreach ($illustrations as $illustration)
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="{{ asset('storage/Illustration/'.$illustration->Illustration)}}" class="img-prod"><img class="img-fluid" src="{{ asset('storage/Illustration/'.$illustration->Illustration)}}" alt="Colorlib Template">
                        ...
                        <div class="text py-3 pb-4 px-3 text-center">
                            ...
                            <div class="d-flex">
                                <div class="pricing">
                                    <p class="price"><!--span class="mr-2 price-dc">$120.00</span--><span class="price-sale">{{ $trano->Nom }}</span></p>
                                </div>
                            </div>
