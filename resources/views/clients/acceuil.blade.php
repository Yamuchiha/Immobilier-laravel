        ...
        <div class="row">
            ...
            @foreach ($tranos as $trano)
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="{{ url('/Detail/'.$trano->Image_Vignette.'/'.$trano->id) }}" class="img-prod"><img class="img-fluid" src="storage/Trano_vignette/{{ $trano->Image_Vignette }}" alt="Colorlib Template">
