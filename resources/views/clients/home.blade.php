...
@section('contenu')
            ...
            <div class="slider-item" style="background-image: url(storage/Slider_image/{{ $slider->slider_image }});">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 ftco-animate text-center">
                        ...
                        <p><a href="#" class="btn btn-primary">Et toujours pour vous</a></p>
                    </div>
	...
	@if (Session::has('arret'))
		<script>
			swal.fire("Attention", " ", "error");
		</script>
	@endif
    </div>
    </section>
        ...
        <div class="row">
            ...
            @foreach ($maisons as $maison)
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="storage/Uploads/{{ $maison->maison_image }}" class="img-prod"><img class="img-fluid" src="storage/Uploads/{{ $maison->maison_image }}" alt="Colorlib Template">
